            ...
            <div class="row">
              <div class="col-lg-6">
                ...
                <div class="d-block d-md-flex listing vertical">
                  <a href="#" class="img d-block" style="background-image: url({{asset('classyads/images/img_1.jpg')}}"></a>
              ...
              <div class="col-lg-6">
                ...
                <div class="d-block d-md-flex listing vertical">
                  <a href="#" class="img d-block" style="background-image: url({{asset('classyads/images/img_2.jpg')}}"></a>
                  <div class="lh-content">
              ...
              <div class="col-lg-6">
                ...
                <div class="d-block d-md-flex listing vertical">
                  <a href="#" class="img d-block" style="background-image: url{{asset('classyads/images/img_4.jpg')}}"></a>
                  <div class="lh-content">
              ...
              <div class="col-lg-6">
                ...
                <div class="d-block d-md-flex listing vertical">
                  <a href="#" class="img d-block" style="background-image: url({{asset('classyads/images/img_3.jpg')}})"></a>
                  <div class="lh-content">
                    <span class="category">Furniture</span>
                    <a href="#" class="bookmark"><span class="icon-heart"></span></a>
                    <h3><a href="#">Wooden Chair &amp; Table</a></h3>
